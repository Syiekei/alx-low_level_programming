...
/**
 * check98 - finds the file_from exists and can be read
 * @check: finds if true of false
 * @file: file_from name
...
/**
 * check99 - finds that file_to was created and/or can be written to
 * @check: finds if true of false
 * @file: file_to name
 * @fd_from: file descriptor of file_from, or -1
 * @fd_to: file descriptor of file_to, or -1
...
/**
 * check100 - finds that file descriptors were closed properly
 * @check: finds if true or false
 * @fd: file descriptor
 *
 * Return: void
 */
